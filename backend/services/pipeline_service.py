...
class PipelineService:
    def read_tenant_rows(self, conn, table: str, tenant_id: str) -> List[Dict[str, Any]]:
        cursor = conn.cursor()
    ...
    def read_tenant_row(self, conn, table: str, tenant_id: str, item_id: str) -> Dict[str, Any]:
        cursor = conn.cursor()
    ...
    def upsert_tenant_row(self, conn, table: str, tenant_id: str, item: Dict[str, Any]) -> Dict[str, Any]:
        cursor = conn.cursor()
    ...
    def update_tenant_row(self, conn, table: str, tenant_id: str, item_id: str, item: Dict[str, Any]) -> Dict[str, Any]:
        self.read_tenant_row(conn, table, tenant_id, item_id)
        cursor = conn.cursor()
        now = datetime.utcnow().isoformat()
        data = {**item, "id": item_id, "tenant_id": tenant_id}
        cursor.execute(
    ...
    def delete_tenant_row(self, conn, table: str, tenant_id: str, item_id: str) -> Dict[str, str]:
        cursor = conn.cursor()
    ...
    def save_log(self, conn, tenant_id: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        cursor = conn.cursor()
        now = datetime.utcnow().isoformat()
    ...
    def get_active_pipelines(self, conn, tenant_id: str) -> List[Dict[str, Any]]:
        cursor = conn.cursor()
    ...
    def trigger_pipeline_sync(self, conn, tenant_id: str, id: str, pipeline_config: Dict[str, Any] | None) -> Dict[str, Any]:
        cursor = conn.cursor()
    ...
    def get_task_status(self, conn, tenant_id: str, task_id: str) -> Dict[str, Any]:
        cursor = conn.cursor()
    ...
    def save_auth_driver(self, conn, tenant_id: str, id: str, code: str) -> Dict[str, str]:
        self.read_tenant_row(conn, "connections", tenant_id, id)
        if not code:
